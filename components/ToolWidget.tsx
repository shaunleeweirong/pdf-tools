...
/**
 * The interactive part of a tool (dropzone → options → run → progress →
 * download). Extracted from ToolLayout so it can be embedded standalone on
 * programmatic use-case pages without the surrounding page chrome.
 */
export function ToolWidget<O>({
  tool,
  defaultOpts,
  renderOptions,
  process,
